...
**19 entries** · [← Root](../README.md) · [← 3D Object / Asset](README.md)

## 🌟 Spotlight

#### 🌟 [SLAT-Phys: Fast Material Property Field Prediction from Structured 3D Latents](https://arxiv.org/abs/2603.23973)

![Venue: arXiv 2026](https://img.shields.io/static/v1?label=Venue&message=arXiv+2026&color=B31B1B&style=flat-square&labelColor=111827) ![Track: 3d-shape-generation](https://img.shields.io/static/v1?label=Track&message=3d-shape-generation&color=0D9488&style=flat-square&labelColor=111827)

> Extends structured 3D latents from geometry toward material-property prediction for simulation-ready assets.

[![Paper: arXiv](https://img.shields.io/static/v1?label=Paper&message=arXiv&color=B31B1B&style=flat-square&labelColor=111827&logo=arxiv)](https://arxiv.org/abs/2603.23973)
