...
**7 entries** · [← Root](../README.md) · [← Video](README.md)

## 🌟 Spotlight

#### 🌟 [P-Flow: Prompting Visual Effects Generation](https://arxiv.org/abs/2603.22091)

![Venue: arXiv 2026](https://img.shields.io/static/v1?label=Venue&message=arXiv+2026&color=B31B1B&style=flat-square&labelColor=111827) ![Track: video-editing](https://img.shields.io/static/v1?label=Track&message=video-editing&color=7C3AED&style=flat-square&labelColor=111827)

> A prompting-based framework for generating controllable visual effects sequences in video.

[![Paper: arXiv](https://img.shields.io/static/v1?label=Paper&message=arXiv&color=B31B1B&style=flat-square&labelColor=111827&logo=arxiv)](https://arxiv.org/abs/2603.22091)
