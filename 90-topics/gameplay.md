...
|:--|:--|:--|:--|:--|
| **Matrix-Game: Interactive World Foundation Model** | 4D Dynamic Scene / World | game-worlds | arXiv 2025 | [Paper](https://arxiv.org/abs/2506.18701) / [Code](https://github.com/SkyworkAI/Matrix-Game) |
| **HY-World 1.5 (WorldPlay): A Systematic Framework for Interactive World Modeling with Real-Time Latency and Geometric Consistency** | 4D Dynamic Scene / World | world-models | arXiv 2025 | [Paper](https://arxiv.org/abs/2512.14614) / [Code](https://github.com/Tencent-Hunyuan/HY-WorldPlay) / [Project](https://3d-models.hunyuan.tencent.com/world/) |
| **Diffusion Models Are Real-Time Game Engines** | 4D Dynamic Scene / World | game-worlds | ICLR 2025 | [Paper](https://arxiv.org/abs/2408.14837) |
| **GameFactory: Creating New Games with Generative Interactive Videos** | 4D Dynamic Scene / World | game-worlds | ICCV 2025 | [Paper](https://arxiv.org/abs/2501.08325) |
| **GameGen-X: Interactive Open-world Game Video Generation** | 4D Dynamic Scene / World | game-worlds | ICLR 2025 | [Paper](https://arxiv.org/abs/2411.00769) |
